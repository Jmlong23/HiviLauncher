...
package com.ljm.audiotoollib.upnpserver.cling.protocol.async;

import com.ljm.audiotoollib.upnpserver.cling.UpnpService;
import com.ljm.audiotoollib.upnpserver.cling.model.DiscoveryOptions;
import com.ljm.audiotoollib.upnpserver.cling.model.Location;
import com.ljm.audiotoollib.upnpserver.cling.model.NetworkAddress;
...
import com.ljm.audiotoollib.upnpserver.cling.model.message.discovery.IncomingSearchRequest;
import com.ljm.audiotoollib.upnpserver.cling.model.message.discovery.OutgoingSearchResponse;
import com.ljm.audiotoollib.upnpserver.cling.model.message.discovery.OutgoingSearchResponseDeviceType;
import com.ljm.audiotoollib.upnpserver.cling.model.message.discovery.OutgoingSearchResponseRootDevice;
import com.ljm.audiotoollib.upnpserver.cling.model.message.discovery.OutgoingSearchResponseServiceType;
import com.ljm.audiotoollib.upnpserver.cling.model.message.discovery.OutgoingSearchResponseUDN;
import com.ljm.audiotoollib.upnpserver.cling.model.message.discovery.OutgoingSearchResponseWiimuDevice;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.DeviceTypeHeader;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.MXHeader;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.RootDeviceHeader;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.STAllHeader;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.ServiceTypeHeader;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.UDNHeader;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.UpnpHeader;
import com.ljm.audiotoollib.upnpserver.cling.model.message.header.WiimudeviceDeviceHeader;
...
public class ReceivingSearch extends ReceivingAsync<IncomingSearchRequest> {
    ...
    protected void sendResponses(UpnpHeader searchTarget, NetworkAddress activeStreamServer) throws RouterException {
        ...
        } else if (searchTarget instanceof WiimudeviceDeviceHeader) {

            sendSearchResponseWiimuDevices(activeStreamServer);
    ...
    protected void sendSearchResponseWiimuDevices(NetworkAddress activeStreamServer) throws RouterException {
        log.fine("Responding to root device search with advertisement messages for all local root devices");
        for (LocalDevice device : getUpnpService().getRegistry().getLocalDevices()) {
            ...
            OutgoingSearchResponse message =
                    new OutgoingSearchResponseWiimuDevice(
                            getInputMessage(),
                            getDescriptorLocation(activeStreamServer, device),
                            device
                    );
