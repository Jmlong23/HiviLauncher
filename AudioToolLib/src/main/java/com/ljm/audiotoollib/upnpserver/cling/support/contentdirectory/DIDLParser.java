...
package com.ljm.audiotoollib.upnpserver.cling.support.contentdirectory;
...
import com.ljm.audiotoollib.upnpserver.cling.support.model.DIDLAttribute;
...
import com.ljm.audiotoollib.upnpserver.cling.support.model.DescMeta;
...
import com.ljm.audiotoollib.upnpserver.cling.support.model.WriteStatus;
 ...
 * </p>
 * <p>
 * Override the {@link #createDescMetaHandler(DescMeta, SAXParser.Handler)}
 * method to read vendor extension content of {@code <desc>} elements. You then should also override the
 * {@link #populateDescMetadata(Element, DescMeta)} method for writing.
 * </p>
 * <p>
 * Override the {@link #createItemHandler(Item, SAXParser.Handler)}
...
public class DIDLParser extends SAXParser {
     ...
     * {@link #createDescMetaHandler(DescMeta, SAXParser.Handler)},
    ...
    protected void appendClass(Document descriptor, Element parent, DIDLObject.Class clazz, String element, boolean appendDerivation) {
        Element classElement = XMLUtil.appendNewElementIfNotNull(
            descriptor,
            parent,
            element,
            clazz.getValue(),
     ...
     * {@link DIDLContent#DESC_WRAPPER_NAMESPACE_URI}.
     * </p>
     */
