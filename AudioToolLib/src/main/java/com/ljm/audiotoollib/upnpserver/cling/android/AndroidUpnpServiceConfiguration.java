...
package com.ljm.audiotoollib.upnpserver.cling.android;

import android.os.Build;

import com.ljm.audiotoollib.upnpserver.cling.DefaultUpnpServiceConfiguration;
import com.ljm.audiotoollib.upnpserver.cling.binding.xml.DeviceDescriptorBinder;
import com.ljm.audiotoollib.upnpserver.cling.binding.xml.RecoveringUDA10DeviceDescriptorBinderImpl;
import com.ljm.audiotoollib.upnpserver.cling.binding.xml.ServiceDescriptorBinder;
import com.ljm.audiotoollib.upnpserver.cling.binding.xml.UDA10ServiceDescriptorBinderSAXImpl;
import com.ljm.audiotoollib.upnpserver.cling.model.Namespace;
import com.ljm.audiotoollib.upnpserver.cling.model.ServerClientTokens;
import com.ljm.audiotoollib.upnpserver.cling.registry.Registry;
import com.ljm.audiotoollib.upnpserver.cling.transport.impl.AsyncServletStreamServerConfigurationImpl;
import com.ljm.audiotoollib.upnpserver.cling.transport.impl.AsyncServletStreamServerImpl;
import com.ljm.audiotoollib.upnpserver.cling.transport.impl.RecoveringGENAEventProcessorImpl;
import com.ljm.audiotoollib.upnpserver.cling.transport.impl.RecoveringSOAPActionProcessorImpl;
import com.ljm.audiotoollib.upnpserver.cling.transport.impl.jetty.JettyServletContainer;
import com.ljm.audiotoollib.upnpserver.cling.transport.impl.jetty.StreamClientConfigurationImpl;
import com.ljm.audiotoollib.upnpserver.cling.transport.impl.jetty.StreamClientImpl;
