...
package com.ljm.audiotoollib.upnpserver.cling.support.avtransport.lastchange;
...
import com.ljm.audiotoollib.upnpserver.cling.support.lastchange.EventedValue;
import com.ljm.audiotoollib.upnpserver.cling.support.lastchange.EventedValueEnum;
import com.ljm.audiotoollib.upnpserver.cling.support.lastchange.EventedValueEnumArray;
import com.ljm.audiotoollib.upnpserver.cling.support.lastchange.EventedValueString;
import com.ljm.audiotoollib.upnpserver.cling.support.lastchange.EventedValueURI;
import com.ljm.audiotoollib.upnpserver.cling.support.lastchange.EventedValueUnsignedIntegerFourBytes;
...
public class AVTransportVariable {
    ...
    public static class TransportState extends EventedValueEnum<com.ljm.audiotoollib.upnpserver.cling.support.model.TransportState> {
        public TransportState(com.ljm.audiotoollib.upnpserver.cling.support.model.TransportState avTransportState) {
        ...
        @Override
        protected com.ljm.audiotoollib.upnpserver.cling.support.model.TransportState enumValueOf(String s) {
            return com.ljm.audiotoollib.upnpserver.cling.support.model.TransportState.valueOf(s);
        }
    }

    public static class TransportStatus extends EventedValueEnum<com.ljm.audiotoollib.upnpserver.cling.support.model.TransportStatus> {
        public TransportStatus(com.ljm.audiotoollib.upnpserver.cling.support.model.TransportStatus transportStatus) {
        ...
        @Override
        protected com.ljm.audiotoollib.upnpserver.cling.support.model.TransportStatus enumValueOf(String s) {
            return com.ljm.audiotoollib.upnpserver.cling.support.model.TransportStatus.valueOf(s);
        }
    }
    ...
    public static class RecordMediumWriteStatus extends EventedValueEnum<com.ljm.audiotoollib.upnpserver.cling.support.model.RecordMediumWriteStatus> {
        public RecordMediumWriteStatus(com.ljm.audiotoollib.upnpserver.cling.support.model.RecordMediumWriteStatus recordMediumWriteStatus) {
        ...
        @Override
        protected com.ljm.audiotoollib.upnpserver.cling.support.model.RecordMediumWriteStatus enumValueOf(String s) {
            return com.ljm.audiotoollib.upnpserver.cling.support.model.RecordMediumWriteStatus.valueOf(s);
        }
    }
