...
package com.ljm.audiotoollib.upnpserver.cling.support.connectionmanager;
...
import com.ljm.audiotoollib.upnpserver.cling.model.ServiceReference;
...
import com.ljm.audiotoollib.upnpserver.cling.support.connectionmanager.callback.ConnectionComplete;
import com.ljm.audiotoollib.upnpserver.cling.support.connectionmanager.callback.PrepareForConnection;
import com.ljm.audiotoollib.upnpserver.cling.support.model.ConnectionInfo;
import com.ljm.audiotoollib.upnpserver.cling.support.model.ProtocolInfo;
import com.ljm.audiotoollib.upnpserver.cling.support.model.ProtocolInfos;
...
public abstract class AbstractPeeringConnectionManagerService extends ConnectionManagerService {
     ...
     *
     * @return <code>-1</code> if the {@link #peerFailure(ActionInvocation, UpnpResponse, String)}
     ...
     * management service. The execution of the {@link #createConnectionWithPeer(ServiceReference, ControlPoint, Service, ProtocolInfo, ConnectionInfo.Direction)}
     * and {@link #closeConnectionWithPeer(ControlPoint, Service, ConnectionInfo)}
