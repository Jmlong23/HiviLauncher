...
package com.ljm.audiotoollib.upnpserver.cling.binding.xml;

import static com.ljm.audiotoollib.upnpserver.cling.model.XMLUtil.appendNewElement;
import static com.ljm.audiotoollib.upnpserver.cling.model.XMLUtil.appendNewElementIfNotNull;

import com.ljm.audiotoollib.upnpserver.cling.binding.staging.MutableDevice;
import com.ljm.audiotoollib.upnpserver.cling.binding.staging.MutableIcon;
import com.ljm.audiotoollib.upnpserver.cling.binding.staging.MutableService;
import com.ljm.audiotoollib.upnpserver.cling.binding.xml.Descriptor.Device.ELEMENT;
...
import com.ljm.audiotoollib.upnpserver.cling.model.XMLUtil;
import com.ljm.audiotoollib.upnpserver.cling.model.meta.Device;
...
import com.ljm.audiotoollib.upnpserver.cling.model.meta.RemoteDevice;
...
import com.ljm.audiotoollib.upnpserver.cling.model.profile.RemoteClientInfo;
import com.ljm.audiotoollib.upnpserver.cling.model.types.DLNACaps;
import com.ljm.audiotoollib.upnpserver.cling.model.types.DLNADoc;
import com.ljm.audiotoollib.upnpserver.cling.model.types.InvalidValueException;
import com.ljm.audiotoollib.upnpserver.cling.model.types.ServiceId;
...
public class UDA10DeviceDescriptorBinderImpl implements DeviceDescriptorBinder, ErrorHandler {
    ...
    protected void generateSpecVersion(Namespace namespace, Device deviceModel, Document descriptor, Element rootElement) {
        Element specVersionElement = XMLUtil.appendNewElement(descriptor, rootElement, ELEMENT.specVersion);
        XMLUtil.appendNewElementIfNotNull(descriptor, specVersionElement, ELEMENT.major, deviceModel.getVersion().getMajor());
        XMLUtil.appendNewElementIfNotNull(descriptor, specVersionElement, ELEMENT.minor, deviceModel.getVersion().getMinor());
    }
    ...
    protected void generateDevice(Namespace namespace, Device deviceModel, Document descriptor, Element rootElement, RemoteClientInfo info) {
        ...
        Element deviceElement = XMLUtil.appendNewElement(descriptor, rootElement, ELEMENT.device);

        XMLUtil.appendNewElementIfNotNull(descriptor, deviceElement, ELEMENT.deviceType, deviceModel.getType());
        ...
        XMLUtil.appendNewElementIfNotNull(descriptor, deviceElement, ELEMENT.UDN, deviceModel.getIdentity().getUdn());
        XMLUtil.appendNewElementIfNotNull(
    ...
    protected void generateIconList(Namespace namespace, Device deviceModel, Document descriptor, Element deviceElement) {
        ...
        Element iconListElement = XMLUtil.appendNewElement(descriptor, deviceElement, ELEMENT.iconList);

        for (Icon icon : deviceModel.getIcons()) {
            Element iconElement = XMLUtil.appendNewElement(descriptor, iconListElement, ELEMENT.icon);

            XMLUtil.appendNewElementIfNotNull(descriptor, iconElement, ELEMENT.mimetype, icon.getMimeType());
            XMLUtil.appendNewElementIfNotNull(descriptor, iconElement, ELEMENT.width, icon.getWidth());
            XMLUtil.appendNewElementIfNotNull(descriptor, iconElement, ELEMENT.height, icon.getHeight());
            XMLUtil.appendNewElementIfNotNull(descriptor, iconElement, ELEMENT.depth, icon.getDepth());
            if (deviceModel instanceof RemoteDevice) {
            	XMLUtil.appendNewElementIfNotNull(descriptor, iconElement, ELEMENT.url,  icon.getUri());
            } else if (deviceModel instanceof LocalDevice) {
            	XMLUtil.appendNewElementIfNotNull(descriptor, iconElement, ELEMENT.url,  namespace.getIconPath(icon));
            }
        }
    }
    ...
    protected void generateServiceList(Namespace namespace, Device deviceModel, Document descriptor, Element deviceElement) {
        ...
        Element serviceListElement = XMLUtil.appendNewElement(descriptor, deviceElement, ELEMENT.serviceList);

        for (Service service : deviceModel.getServices()) {
            Element serviceElement = XMLUtil.appendNewElement(descriptor, serviceListElement, ELEMENT.service);

            XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.serviceType, service.getServiceType());
            XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.serviceId, service.getServiceId());
            if (service instanceof RemoteService) {
                RemoteService rs = (RemoteService) service;
                XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.SCPDURL, rs.getDescriptorURI());
                XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.controlURL, rs.getControlURI());
                XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.eventSubURL, rs.getEventSubscriptionURI());
            } else if (service instanceof LocalService) {
                LocalService ls = (LocalService) service;
                XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.SCPDURL, namespace.getDescriptorPath(ls));
                XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.controlURL, namespace.getControlPath(ls));
                XMLUtil.appendNewElementIfNotNull(descriptor, serviceElement, ELEMENT.eventSubURL, namespace.getEventSubscriptionPath(ls));
            }
        }
    }
    ...
    protected void generateDeviceList(Namespace namespace, Device deviceModel, Document descriptor, Element deviceElement, RemoteClientInfo info) {
        ...
        Element deviceListElement = XMLUtil.appendNewElement(descriptor, deviceElement, ELEMENT.deviceList);
